...
*******************************************************************************/
//============================================================================
// Name        : sistema que gerencia os imóveis de uma imobiliária.
// Author      :
// Version     : 2.0
...
void Cons_Tipo_Studio(int c){
    ...
    for(i=0;i<=c-1;i++){
                    ...
                    printf("\n Area do Studio:%f ",studio[i].area);
                    printf("\n Valor do condominio:%f ",studio[i].cond);
